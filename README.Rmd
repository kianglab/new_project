...
- **`data_private/`**: In this folder are data that **_cannot_ be shared**. Data files in this folder will be `.gitignore`d and not shared. 
...
- **`rmds/`**: Should contain rmarkdown or quarto files (and maybe their resulting output files) for the tables used in the manuscript. Tables should never be entered by hand. This both minimizes mistakes and allows us to quickly update our numbers when we received new data or change the analysis. 
